...
--->
<cfcomponent output="false" displayname="testSecurityService" hint="" extends="cfprototype._tests.unit.CFUnitBase">

<cfset configure() />

<cffunction name="configure" returntype="void" access="private" output="false" hint="">
	<cfset variables._config =  ''/>
</cffunction>

<cffunction name="testVarScope" returntype="void" access="public" output="false">
	<cfset super.varScopeChecker( 'SecurityService.cfc' ) />
</cffunction>
